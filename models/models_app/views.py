...
def list_drivers(request):
    ...
    for driver in drivers:
        result.append({"first_name": driver.first_name, "last_name": driver.last_name, "car_model": driver.car_model,"rating": driver.rating, "id": driver.id})
...
def get_driver(request, id):
    ...
    return JsonResponse({'state': "Success", 'driver': {"first_name" : driver.first_name, "last_name"  : driver.last_name, "car_model" : driver.car_model, "rating" : driver.rating, "id": driver.id}})
